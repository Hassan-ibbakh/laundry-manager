...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow p-6 mb-4">
        ...
        <div class="grid grid-cols-2 gap-4 text-sm mb-6">
            ...
            <div><p class="text-gray-400">الخدمة</p><p class="font-medium"><?php echo e($order->service); ?></p></div>
            <div><p class="text-gray-400">عدد القطع</p><p class="font-medium"><?php echo e($order->pieces_count); ?></p></div>
            <div><p class="text-gray-400">نوع القطع</p><p class="font-medium"><?php echo e($order->pieces_type); ?></p></div>
            <div><p class="text-gray-400">اللون</p><p class="font-medium"><?php echo e($order->pieces_color ?? '—'); ?></p></div>
            <div><p class="text-gray-400">المبلغ</p><p class="font-bold text-blue-600 text-lg"><?php echo e($order->price); ?> د.م</p></div>
        </div>
        ...
        <div class="flex flex-wrap gap-3 pt-4 border-t">
            <a href="<?php echo e(route('laundry.orders.pdf', $order->id)); ?>" target="_blank"
