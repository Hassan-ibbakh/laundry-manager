...
<div class="max-w-2xl mx-auto py-8">
    ...
    <div class="form-card p-8">
        ...
        <form method="POST" action="<?php echo e(route('admin.laundries.store')); ?>" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" value="<?php echo e(old('phone')); ?>" required
                        ...
                        class="<?php echo e($errors->has('phone') ? 'error' : ''); ?>">
                </div>
