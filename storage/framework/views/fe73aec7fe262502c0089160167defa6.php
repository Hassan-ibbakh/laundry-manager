...
<body class="bg-gray-100 font-sans">
    ...
    <nav class="bg-gradient-to-l from-blue-500 to-violet-500 text-white shadow-lg">
        <div class="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
            <h1 class="text-xl font-bold">🧺 <?php echo e(auth('laundry')->user()->name); ?></h1>
            <div class="flex items-center gap-4">
                <form method="POST" action="<?php echo e(route('laundry.logout')); ?>">
                    <?php echo csrf_field(); ?>
                    <button class="bg-white text-blue-600 px-3 py-1 rounded text-sm font-semibold hover:bg-gray-100">
                        خروج
                    </button>
                </form>
            </div>
