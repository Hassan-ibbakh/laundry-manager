    ...
    <div class="bg-white shadow-sm border-b">
        <div class="max-w-7xl mx-auto px-4 flex gap-6 py-2">
            <a href="{{ route('admin.dashboard') }}"
               class="text-sm font-medium {{ request()->routeIs('admin.dashboard') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-blue-600' }}">
                الرئيسية
            </a>
            <a href="{{ route('admin.laundries.index') }}"
               class="text-sm font-medium {{ request()->routeIs('admin.laundries.*') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-600 hover:text-blue-600' }}">
                المغاسل
            </a>
        </div>
    </div>
