...
<head>
    ...
    <style>
        :root {
            /* Échelle fluide : s'adapte du mobile (360px) jusqu'aux téléviseurs 4K (3840px) */
        ...
        /* Conteneur : largeur fluide, jamais trop étroite sur mobile ni trop large sur TV */
        .login-wrapper {
            width: 100%;
        ...
        /* Petits mobiles : on resserre les marges et on désactive le hover-lift */
        @media (max-width: 360px) {
            .glass-card { padding: 1.25rem; }
        }

        /* Téléviseurs / très grands écrans (salles de contrôle, affichage mural, etc.) :
           on plafonne la largeur pour ne pas étirer le formulaire à l'infini
           et on agrandit légèrement le texte pour la distance de lecture. */
        ...
        /* Mode paysage bas (tablette/mobile à l'horizontale) : on réduit les espacements verticaux */
...
<body class="min-h-screen login-bg">
    <div class="login-wrapper animate__animated animate__fadeInUp">
        ...
        <div class="brand-block text-center mb-8">
            <div class="brand-icon-wrap inline-flex items-center justify-center bg-white/20 backdrop-blur-sm rounded-full p-4 mb-4">
        ...
        <div class="glass-card">
            <div class="text-center mb-8">
                <h2 class="card-title font-bold text-gray-800">مرحبا</h2>
                <p class="card-subtitle text-gray-500 mt-1">سجّل الدخول إلى لوحة الإدارة</p>
                <div class="flex justify-center gap-2 mt-3">
                    <span class="inline-block w-2 h-2 rounded-full bg-green-500 pulse-dot"></span>
                    <span class="helper-text text-gray-400">نظام آمن</span>
                </div>
            </div>
            ...
            @if($errors->any())
                <div class="bg-red-50 border-r-4 border-red-500 rounded-lg px-4 py-3 mb-6 animate__animated animate__shakeX">
                    <div class="flex items-center gap-2 text-red-700">
                        ...
                        <span class="helper-text font-medium">{{ $errors->first() }}</span>
                    </div>
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('admin.login.post') }}" class="space-y-6">
                ...
                <div class="input-group">
                    <label class="block font-medium text-gray-700 mb-2">البريد الإلكتروني</label>
                    <div class="relative">
                ...
                <div class="input-group">
                    <label class="block font-medium text-gray-700 mb-2">كلمة المرور</label>
                    <div class="relative">
                ...
                <div class="flex flex-wrap gap-3 items-center justify-between">
                    <label class="flex items-center gap-2 helper-text text-gray-600">
