...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth.admin')->group(function () {
        ...
        Route::get('laundries/{laundry}/orders', [AdminLaundry::class, 'orders'])->name('laundries.orders');
...
Route::prefix('laundry')->name('laundry.')->group(function () {
    ...
    Route::middleware('auth.laundry')->group(function () {
        ...
        Route::get('orders/{id}/ticket', [OrderController::class, 'ticket'])->name('orders.ticket');
